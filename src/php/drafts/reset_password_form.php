...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="reset_password_form.php?reset_code=<?php echo $_GET['reset_code']; ?>" method="POST" class="space-y-6">
            <div>
            ...
            <div>
                ...
                <button
                    ...
                    class="w-full bg-green-950 text-white py-2 px-4 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500"
                >
                    Reset Password
                </button>
            </div>
