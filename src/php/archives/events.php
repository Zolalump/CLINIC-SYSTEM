...
if (bookButton) {
    bookButton.addEventListener("click", function () {
        let activeTab = document.querySelector(".option-tab.active")?.getAttribute("data-tab") || "events";
            ...
            fetch("/WebDa/booking/src/php/send-msg/mark_notif.php", { method: "POST" })
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        notificationBadge.classList.add("hidden"); // Hide red circle
                    } else {
