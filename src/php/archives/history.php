        ...
        <div class="absolute top-11 flex flex-col w-full items-center px-4 md:px-0">
            ...
            <div class="flex flex-col sm:flex-row mt-8 sm:mt-12 space-y-4 sm:space-y-0 mb-10">    
                <div class="bg-white flex flex-col lg:w-[900px] lg:h-[130%] sm:w-[500px] md:w-[200px] p-6 rounded-xl border-2 border-white mb-4">
                    <span style="text-align: center; " class="font-semibold text-l app-color-lavendar mb-5">Booking History</span>
                    <div class="reservation-details">
                        <div id="booking-history-list" style="opacity: 1;">
                            <p>Empty</p> 
                        </div>  
                    </div>
                </div>
    ...
    <script>
        ...
        fetch("/WebDa/booking/src/php/fetch_booking_history.php")
            ...
            .then(data => {
                ...
                if (!data.success || data.bookings.length === 0) {
                    ...
                    data.bookings.forEach(reservation => {
                        ...
                        let statusBadge = reservation.status === "approved"
                            ? `<span>Approved</span>`
                            : `<span>Canceled</span>`;
            ...
            .catch(error => {
                ...
                document.getElementById("booking-history-list").innerHTML = "<p>Error loading history.</p>";
            });
    });
