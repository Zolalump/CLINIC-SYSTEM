...
<body>
    ...
    <section id="signIn" class="flex items-center justify-center min-h-screen bg-gray-100">
        <section class="relative flex flex-col m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
          ...
          <form action="./src/php/register_admin.php" method="POST">
            <section class="py-4">
            ...
            <section class="flex justify-end mb-3">
              <a href="./src/php/forgot-pass-admin.php" class="text-sm font-medium text-primary-600 hover:underline dark:text-blue-800">Forgot password?</a>
            </section>
            <input
              type="submit"
