...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare('DELETE FROM admin_password_resets WHERE reset_code = ?');
    $stmt->bind_param('s', $resetCode);
    $stmt->execute();
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="reset_password_form_adm.php?reset_code=<?php echo $_GET['reset_code']; ?>" method="POST" class="space-y-6">
            <div>
